...
from transE import TransE_Source
...
# INITIALIZE MODEL
# =========================================
transE = TransE_Source(len(all_rels), len(ent2id), len(all_sources), dim=config['embedding_dim'], norm=config['norm'])
transE.to(device)
...
with open(os.path.join(model_dir, 'test_eval1.tsv'), 'w') as f:
	f.write("MR\tMRR\tH@10\n")
	f.write("{}\t{}\t{}\n".format(MR, MRR, h10))
