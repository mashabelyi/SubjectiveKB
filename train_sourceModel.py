...
from transE import TransE_Source, TransE_SourceFull
...
# INITIALIZE MODEL
# =========================================
transE = TransE_SourceFull(len(all_rels), len(ent2id), len(src2id), dim=args.embedding_dim, norm=args.norm)
transE.to(device)
...
for epoch in range(args.num_epochs):
	...
	while loader.has_next():
		...
		# optimizer.zero_grad() # DO THIS! Did not do for baseline so commenting for now..
		...
		# NEW: penalize large add-on vectors
		# batchLoss += 0.001 * transE.get_regularizer()
	...
	# valLoss += 0.01 * transE.get_regularizer()
...
# MR, MRR, h10 = transE.validate_fast(test, test_dict, all_ents, all_rels, all_sources)
# print("\n\nRESULTS ON TEST SET")
# print("====================================")
# print("MR = {}, MRR = {:.4}, H@10 = {:.4}\n".format(round(MR), MRR, h10))
